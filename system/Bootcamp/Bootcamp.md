...
which they are "acquiring, SIMULTANEOUSLY HEREWITH", in favor of ALLIED
WOODBROOK, INC. (108-18 Queens Boulevard, Forest Hills), owner and
operator of the sewage treatment plant serving the premises.

## R39-1 — THE PRIVATE-SEWER COVENANT IS AN INSTRUMENT CLASS, NOT A ONE-OFF

Run 34 (1976, Springville Construction Corp.) and this (1984, Allied
Woodbrook, Inc.) are the SAME MACHINE, eight years and two companies
apart: buyer must encumber the parcel with an annual charge to the
plant owner; the charge becomes a LIEN on default; the covenant runs
with the land and rides into all future deeds "as if inserted"; and it
sunsets on the SAME EVENT PAIR — gravity discharge into the City sewer
system OR City acquisition of the plant, whichever is earlier.
DERIVATION CONSEQUENCE: Staten Island's unsewered fringe carries a
POPULATION of these regimes, so any parcel there may hold a recurring
charge-lien generated by covenant and calendar with nothing further
recorded. This is now a class to detect, not a curiosity.

⚠ THE TERMS DIFFER, AND THE DIFFERENCE IS THE DATA:
  R34 (1976): pro-rata FORMULA (total plant cost ÷ connected units),
              capped $75/yr, self-subordinating to institutional first
  ...
  R39 (1984): FLAT rates — $150.00/yr per one-family dwelling,
              ...
              increase requires approval) — a private charge under
              public rate regulation, where R34 used a private cap
              instead. Two designs for one problem; extraction must
              read the terms, never infer them from the class.

## R39-2 — THE DOCUMENT MISSPELLS ITS OWN DECLARANT, AND THE INDEX IS RIGHT

Page 1 (read at 450dpi): "RICHARD FUSCHINO and CATHERINE **FISCHINO**".
The signature block, the acknowledgment and the backer all read
FUSCHINO; rd carries FUSCHINO for both parties. So the instrument is
SELF-INCONSISTENT on a party surname and the INDEX IS THE MORE ACCURATE
WITNESS. This does not overturn "the document outranks the index" — it
bounds it: THAT RULE ASSUMES THE DOCUMENT HAS ONE READING. Where an
instrument contradicts itself, no single document-side reading exists,
and the index becomes a third witness to weigh rather than a subordinate
to correct. For the stakeholder graph: capture BOTH spellings as
variants of one party (an alias edge born inside a single instrument).

## R39-3 — RICHMOND'S THIRD SERIES: THE REEL

rd book="28" page="5495" decodes to the stamps "REEL 28 PAGE 5495"
(running 5495-5499 across the five pages). Richmond's recording series
is therefore LIBER (deeds / mortgages, two shelves — R11-1) → REEL →
LAND DOC. ⚠ COLLISION: ACRIS film also cites reel-page (FT_ ids), so
"reel 28 page 5495" is meaningless without its CUSTODIAN. The namespace
family gains its seventh member and its second custodian-collision.

## CONFIRMATIONS

- rd: DECLARATION ✓ 6/26/1984 ✓ book/page = reel/page ✓ parties 2/2 ✓ ·
  key 5070480009 EARNED — the backer states "the land affected by the
  within instrument lies in Block 7048 Lot 9 on the Tax Map of the
  County of Richmond" (document-side witness, and it names the TAX MAP
  explicitly, unlike R29's land-map divergence).
...
- Schedule A header "TRIPLE E    #23    94 CHARLESTON AVENUE" — "TRIPLE
  E" and "#23" are UNEXPLAINED IN THE DOCUMENT; plausibly a project and
  lot-within-project designation, but the instrument does not say so.
  Banked verbatim as an unexplained header (a candidate eighth
  namespace, unconfirmed).
- Metes: 40.00 x 99.96 / 99.95 off Charleston Avenue (54 feet wide),
  160.00 feet east of Winant Avenue "as adopted by the City of New
  York".
